...
public class ModRecipes {
    ...
    public static final RecipeSerializer<ForgeDustRecipe> FORGE_DUST_SERIALIZER = new RecipeSerializer<>(ForgeDustRecipe.MAP_CODEC, ForgeDustRecipe.STREAM_CODEC);
    ...
    public static void registerModRecipes() {
        ...
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Constants.id("forge_dust"), FORGE_DUST_SERIALIZER);
