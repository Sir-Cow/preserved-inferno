...
public class ModPotions {
    ...
    public static final Holder<Potion> STRONG_MINING_FATIGUE = register("strong_mining_fatigue", new Potion("mining_fatigue", new MobEffectInstance(MobEffects.MINING_FATIGUE, 6000, 1)));
    ...
    public static final Holder<Potion> STRONG_LUCK = register("strong_luck", new Potion("luck", new MobEffectInstance(MobEffects.LUCK, 6000, 1)));
