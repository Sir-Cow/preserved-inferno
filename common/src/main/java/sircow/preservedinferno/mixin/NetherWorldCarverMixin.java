...
public class NetherWorldCarverMixin {
    ...
    private int pinferno$useConfiguredLavaLevel(int original, @Local(argsOnly = true, name = "context") CarvingContext context, @Local(argsOnly = true, name = "configuration") CaveCarverConfiguration config) {
        return config.lavaLevel.resolveY(context) - 31;
    }
}
