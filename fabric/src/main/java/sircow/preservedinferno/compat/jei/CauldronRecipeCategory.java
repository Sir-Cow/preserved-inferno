...
public class CauldronRecipeCategory extends AbstractRecipeCategory<CauldronRecipe> {
    ...
    public CauldronRecipeCategory(IGuiHelper guiHelper) {
        super(PreservedJeiPlugin.CAULDRON, Component.translatable("block.minecraft.cauldron"), guiHelper.createDrawableItemStack(new ItemStack(Items.CAULDRON)), 150, 60);
    }
