...
public class ModItems {
    ...
    private static RegistryKey<Item> keyOf(String id) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PreservedInferno.MOD_ID, id));
    }
    ...
    public static void registerModItems() {
        PreservedInferno.LOGGER.info("Registering Mod Items for " + PreservedInferno.MOD_ID);
    }
}
