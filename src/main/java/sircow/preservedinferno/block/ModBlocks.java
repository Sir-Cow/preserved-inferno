...
public class ModBlocks {
    ...
    private static RegistryKey<Block> keyOf(String path) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(PreservedInferno.MOD_ID, path));
    }

    public static void registerModBlocks(){
        PreservedInferno.LOGGER.info("Registering Mod Blocks for " + PreservedInferno.MOD_ID);
    }
}
