...
public class NewEnchantingTableBlockScreen extends HandledScreen<NewEnchantingTableBlockScreenHandler> {
    private static final Identifier[] LEVEL_TEXTURES = new Identifier[]{
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/10_levels_enabled"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/20_levels_enabled"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/30_levels_enabled")
    };
    private static final Identifier[] LEVEL_DISABLED_TEXTURES = new Identifier[]{
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/10_levels_disabled"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/20_levels_disabled"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/30_levels_disabled")
    };
    private static final Identifier[] ENCHANTMENT_ICON_TEXTURES = new Identifier[]{
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/aqua_affinity"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/bane_of_arthropods"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/blast_protection"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/breach"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/channeling"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/density"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/depth_strider"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/efficiency"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/feather_falling"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/fire_aspect"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/fire_protection"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/flame"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/fortune"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/impaling"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/infinity"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/knockback"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/looting"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/loyalty"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/luck_of_the_sea"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/lure"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/multishot"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/piercing"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/power"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/projectile_protection"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/protection"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/punch"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/quick_charge"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/respiration"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/riptide"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/sharpness"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/silk_touch"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/smite"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/sweeping_edge"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/thorns"),
            Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchant_overlay/unbreaking"),
    };

    private static final Identifier ENCHANTMENT_SLOT_DISABLED_TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchantment_slot_disabled");
    private static final Identifier ENCHANTMENT_SLOT_HIGHLIGHTED_TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchantment_slot_highlighted");
    private static final Identifier ENCHANTMENT_SLOT_TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/enchantment_slot");
    private static final Identifier TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"textures/gui/container/new_enchanting_table_gui.png");
    private static final Identifier BOOK_TEXTURE = Identifier.ofVanilla("textures/entity/enchanting_table_book.png");
    private static final Identifier SCROLLER_TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/scroller");
    private static final Identifier SCROLLER_DISABLED_TEXTURE = Identifier.of(PreservedInferno.MOD_ID,"container/enchanting_table/scroller_disabled");
