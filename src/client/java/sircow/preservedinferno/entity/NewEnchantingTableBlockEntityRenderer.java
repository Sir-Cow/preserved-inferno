...
import sircow.preservedinferno.block.entity.NewEnchantingTableBlockEntity;
...
public class NewEnchantingTableBlockEntityRenderer implements BlockEntityRenderer<NewEnchantingTableBlockEntity> {
    ...
    @Override
    public void render(
            NewEnchantingTableBlockEntity enchantingTableBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j
    ) {
        matrixStack.push();
